#--------------------
#Sampling and fitting function for T-model
#-------------------
...
#-----------
#Sampling functions New to t-model
#-----------
...
#SigmaVlInv: diagonal matrix with v^-1_ij
...
#vlList: list of the vij's for each group
