%latex.default(tab2, title = "$f$", label = "tlmTableWithGaus",     rgroup = c("Tukey ($n=1000$)", "Tukey ($n=2000$) ", "Huber  ($n=1000$)",         "Huber ($n=2000$)", "Gaussian  ($n=1000$)", "Gaussian ($n=2000$)"),     n.rgroup = c(2, 2, 2, 2, 2, 2), caption.loc = "bottom", math.col.names = TRUE,     rgroupTexCmd = "mdseries", size = "small", file = "tlmTable2WithGaus.tex",     caption = "Mean (standard deviation) of TLM for `Type 1' agencies for the restricted non-hierarchical and hierarchical models for $n=1000$ and $2000$. The table is used for comparision of the two methods and a summary appears in the text. Also supplied are the values for the Gaussian model fits")%
\begin{table}[!tbp]
{\small
\begin{center}
\begin{tabular}{lllll}
