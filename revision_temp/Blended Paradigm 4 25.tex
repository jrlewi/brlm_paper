...
\end{eqnarray}
where \blue{$\pi(\bth)$ is the prior distribution and} $m(T(\by))$ is the marginal distribution of $T(\by)$ under \blue{this prior \sout{the prior distribution}}.  
...
\green{\cite{lewis2012} make use of robust regression estimators for $T(\by)$.}  
