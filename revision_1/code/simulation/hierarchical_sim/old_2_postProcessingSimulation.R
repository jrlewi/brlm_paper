...
#}
load('//trad/profs$/maceachern.1/Desktop/LEWIS.LEE/codeForPaper/codeForPaper/StevesimWork.RData') # SteveMod
...
#}
save.image('//trad/profs$/maceachern.1/Desktop/LEWIS.LEE/codeForPaper/codeForPaper/StevesimPostProc.RData') # SteveMod
